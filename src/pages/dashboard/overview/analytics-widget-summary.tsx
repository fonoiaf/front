...
import { bgGradient } from '#/utils/mixins';
...
export function AnalyticsWidgetSummary({
  ...
  return (
    <Card
      sx={{
        ...bgGradient({
          color: `135deg, ${varAlpha((theme.vars || theme).palette[color].lighterChannel, 0.48)}, ${varAlpha((theme.vars || theme).palette[color].lightChannel, 0.48)}`,
        }),
        p: 3,
        boxShadow: 'none',
        position: 'relative',
