...
import { varAlpha, stylesMode } from '#/utils/styles';
  ...
  const defaultColor = {
    ...(color === 'default' && {
      ...
      ...(variant === 'outlined' && {
        ...
        border: `2px solid ${(theme.vars || theme).palette.text.primary}`,
      }),
      /**
       * @variant soft
       */
      ...(variant === 'soft' && {
        ...
        // backgroundColor: varAlpha((theme.vars || theme).palette.grey['500'], 0.16),
  ...
  const styleColors = {
    ...(color !== 'default' && {
      ...
      ...(variant === 'outlined' && {
        ...
        border: `2px solid ${(theme.vars || theme).palette[color].main}`,
      }),
      /**
       * @variant soft
       */
