...
export const Logo = forwardRef<HTMLDivElement, LogoProps>(
  (
    ...
    const TEXT_PRIMARY = (theme.vars || theme).palette.text.primary;
    const PRIMARY_LIGHT = (theme.vars || theme).palette.primary.light;
    const PRIMARY_MAIN = (theme.vars || theme).palette.primary.main;
    const PRIMARY_DARKER = (theme.vars || theme).palette.primary.dark;
